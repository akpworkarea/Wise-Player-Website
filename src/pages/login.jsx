...
const brandFeatures = [
  {
    icon: Shield,
    textKey: "login_secure_reseller",
  },
  {
    icon: CheckCircle2,
    textKey: "login_full_dashboard",
  },
  {
    icon: Flame,
    textKey: "login_premium_tools",
  },
];
              ...
              {availableLanguages.map((lang) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-4 py-3 border-0 transition-colors duration-150 ${
                      active
                        ? "bg-[#800000]/[0.04]"
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-xs font-bold text-[#1a1a1a] leading-none">
                          {lang.flag}
                        </p>
...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    if (result.success) {
      ...
      // Token present → unverified email
                      ...
                      <motion.button
                        ...
                        className={`w-full h-11 rounded-xl font-bold text-sm border-0 flex items-center justify-center gap-2 transition-colors duration-200 ${
                          loading
                            ...
                            : "bg-[#1a1a1a] hover:bg-black text-white shadow-sm cursor-pointer"
                        }`}
                      >
